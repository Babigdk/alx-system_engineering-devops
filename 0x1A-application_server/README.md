...
* **2. Serve a page with Nginx**
  * [2-app_server-nginx_config](./2-app_server-nginx_config): Nginx configuration file
  proxying requests on the route `/airbnb-onx configuration file
...
* **7. No service interruption**
  * [4-reload_gunicorn_no_downtime](./4-reload_gunicorn_no_downtime): Bash script that gracefully
  reloads Gunicorn.
nepage/` to the Gunicorn app running on
  port `5000`.
...
* **5. Serve your AirBnB clone**
  ...
  * [5-app_server-nginx_config](./5-app_server-nginx_config): Ngi
